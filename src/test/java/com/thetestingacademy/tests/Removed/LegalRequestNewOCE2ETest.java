...
public class LegalRequestNewOCE2ETest extends BaseTest {

    @Test
    @Owner("Koyel")
    @Severity(SeverityLevel.CRITICAL)
    @Description("Full E2E Flow - Login → Initiate → Form → New OC")
...
// ✅ ASSERTION
        ...
        LegalRequestNewOCPage newOCPage = new LegalRequestNewOCPage(driver);
        ...
        // =========================
        // STEP 4 - TC4 NEW OC FLOW
        // =========================
        Allure.step("STEP 4 - TC4 New OC Flow", () -> {
            newOCPage.fillNewOCRequest();
            Thread.sleep(2000);
        });
        ...
        // FINAL STATUS
        // =========================
        System.out.println("✅ FULL E2E PASSED (TC1 + TC2 + TC4)");
