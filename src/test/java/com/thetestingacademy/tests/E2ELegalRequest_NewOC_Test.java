...
import com.thetestingacademy.pages.ReviewNewVendorPage;
import com.thetestingacademy.pages.ReviewConflictWaiverPage;
import com.thetestingacademy.pages.ReviewOFACNewVendorPage;
...
public class E2ELegalRequest_NewOC_Test extends BaseTest {
    ...
    public void e2e_new_oc_flow() {
        ...
        Allure.step("Navigate Home + Open NEW OC Request", () -> {
            new New_OC_Request_NavigatorPage(driver, dataModel).newOCRequest();
        });
    ...
    private void executeTaskConflictWaiver() {
        ...
        ReviewConflictWaiverPage ConflictPage =
                new ReviewConflictWaiverPage(driver, dataModel);
    ...
    private void executeTaskExecuteEL() {
        ...
        ExecuteAndUploadELPage ELPage =
                new ExecuteAndUploadELPage(driver, dataModel);
